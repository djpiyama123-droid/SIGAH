...
Secciones:
  ...
  - MINIMAX:           Fallback a API nube MiniMax cuando Ollama no responde
...
# ── IA Nube — Fallback MiniMax (API OpenAI-compatible) ───────────
# Se usa automáticamente cuando el nodo edge (Ollama) no responde.
# SIGAB_MINIMAX_API_KEY debe configurarse en .env de producción.
